...
import numpy as np
import copy
from rainbow_DQN.network import Dueling_Net, Net
...
class DQN(object):
    ...
    def learn(self, replay_buffer, total_steps):
        batch, batch_index, IS_weight = replay_buffer.sample(total_steps, self.device)
        ...
        td_errors: torch.Tensor = q_current - q_target  # shape：(batch_size,)
