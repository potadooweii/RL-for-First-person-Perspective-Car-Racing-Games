...
class Dueling_Net(nn.Module):
    def __init__(self, args):
        ...
        if args.use_noisy:
            self.V = NoisyLinear(16*(args.state_dim[1]//8)**2, 1)
            self.A = NoisyLinear(16*(args.state_dim[1]//8)**2, args.action_dim)
        else:
            self.V = nn.Linear(16*(args.state_dim[1]//8)**2, 1)
            self.A = nn.Linear(16*(args.state_dim[1]//8)**2, args.action_dim)
...
class Net(nn.Module):
    def __init__(self, args):
        ...
        if args.use_noisy:
            self.fc3 = NoisyLinear(16*(args.state_dim[1]//8)**2, args.action_dim)
        else:
            self.fc3 = nn.Linear(16*(args.state_dim[1]//8)**2, args.action_dim)
